class ReleaseTranslationConstants {
  ...
  static const String releaseAuthor = 'releaseAuthor';
  ...
  static const String publishOnPlatform = 'publishOnPlatform';
  static const String submitReleaseMsg = 'submitReleaseMsg';
  static const String publishOnPlatformMsg = 'publishOnPlatformMsg';
  ...
  static const String creatingWebLink = 'creatingWebLink';
  static const String webLinkCreated = 'webLinkCreated';
  static const String webLinkFailed = 'webLinkFailed';
  static const String freeSingleReleaseUploadMsg = 'freeSingleReleaseUploadMsg';
  static const String onlineClinic = 'onlineClinic';
  static const String appItemTypeA = 'appItemTypeA';
  static const String appItemTypeB = 'appItemTypeB';
  static const String useAsCustomPublisher = 'useAsCustomPublisher';
  static const String searchPublisher = 'searchPublisher';
  static const String selfPublished = 'selfPublished';

  // Cache and upload status constants
  static const String pendingDraftFound = 'pendingDraftFound';
  static const String continueWithPrevious = 'continueWithPrevious';
  static const String startNewPositioning = 'startNewPositioning';
  static const String draftProgress = 'draftProgress';
  static const String draftResumeError = 'draftResumeError';
  static const String uploadingCover = 'uploadingCover';
  static const String creatingCatalog = 'creatingCatalog';
  static const String uploadingFile = 'uploadingFile';
  static const String creatingPost = 'creatingPost';
  static const String finalizingUpload = 'finalizingUpload';
  static const String coverUploadFailed = 'coverUploadFailed';
  static const String catalogCreationFailed = 'catalogCreationFailed';
  static const String fileUploadFailed = 'fileUploadFailed';
  static const String itemCreationFailed = 'itemCreationFailed';

  // Validation
  static const String missingRequiredFields = 'missingRequiredFields';

  // WooCommerce
  static const String wooProductCreationFailed = 'wooProductCreationFailed';

  // Retry
  static const String uploadFailedRetry = 'uploadFailedRetry';

  // Share confirmation dialog
  static const String sharePubliclyTitle = 'sharePubliclyTitle';
  static const String sharePubliclyMessage = 'sharePubliclyMessage';
